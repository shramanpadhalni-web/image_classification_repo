...
pipeline {
    ...
    environment {
        author_name = "Hem Chandra Padhalni"
        author_email = "hem.chandra@corestack.io"
        app_name = "image_classification_repo"
        job_location = "Pipeline-as-code/DEEP-OC-org/DEEP-OC-image_classification_repo/${env.BRANCH_NAME}"
    }
